...
class CouldNotFindLiveNodeConnectedToApiServerAlert(Alert):
    ...
    def __init__(self, monitor: str) -> None:
        super().__init__('{} could not find a live node connected to the API '
...
class CouldNotFindLiveArchiveNodeConnectedToApiServerAlert(Alert):
    ...
    def __init__(self, monitor: str) -> None:
        super().__init__('{} could not find a live archive node connected to '
                         'the API Server. Slashing alerts will now be disabled '
                         'temporarily as these require data from previous '
...
class FoundLiveArchiveNodeAgainAlert(Alert):
    ...
    def __init__(self, monitor: str) -> None:
        super().__init__('{} found an archive node. This means that archive '
                         'monitoring (which includes slashing) is now enabled.'
                         .format(monitor))
...
class ApiIsUpAgainAlert(Alert):
    ...
    def __init__(self, monitor: str) -> None:
        super().__init__('{} connected with the API Server again.'
                         .format(monitor))
...
class ApiIsDownAlert(Alert):
    ...
    def __init__(self, monitor: str) -> None:
        super().__init__('{} lost connection with the API Server. Please make '
...
class NodeIsNotAnArchiveNodeAlert(Alert):
    ...
    def __init__(self, monitor: str, node: str) -> None:
        super().__init__('{} is not an archive node. {} Will try to find '
                         ...
                         'accordingly since non archive nodes only store data '
                         'from the last 256 blocks.'.format(monitor, node))
