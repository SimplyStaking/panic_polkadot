...
from alerter.src.utils.get_json import get_polkadot_json, get_json

GET_JSON_FUNCTION = 'alerter.src.utils.get_json.get_json'
GET_FUNCTION = 'alerter.src.utils.get_json.requests.get'
