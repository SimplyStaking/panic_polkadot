...
USER_CONFIG_FILE_MAIN = 'alerter/config/user_config_main.ini'
USER_CONFIG_FILE_NODES = 'alerter/config/user_config_nodes.ini'
USER_CONFIG_FILE_REPOS = 'alerter/config/user_config_repos.ini'
